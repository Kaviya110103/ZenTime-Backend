...
public class Employee {
    ...
    // NEW FIELDS FOR FIXED TIME SCHEDULE
    @Column(name = "actual_time_in")
    private LocalTime actualTimeIn; // Fixed time in for the employee (HH:mm format)

    @Column(name = "actual_time_out")
    private LocalTime actualTimeOut; // Fixed time out for the employee (HH:mm format)

    // Getters and Setters for new fields
    public LocalTime getActualTimeIn() {
        return actualTimeIn;
    }

    public void setActualTimeIn(LocalTime actualTimeIn) {
        this.actualTimeIn = actualTimeIn;
    }

    public LocalTime getActualTimeOut() {
        return actualTimeOut;
    }

    public void setActualTimeOut(LocalTime actualTimeOut) {
    ...
    public Employee(Long id, String firstName, String lastName, String mobile, String gender, String position,
            ...
            String weekOff, LocalTime actualTimeIn, LocalTime actualTimeOut) {
        this.id = id;
